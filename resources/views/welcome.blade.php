        ...
        <div class="max-w-8xl mx-auto sm:px-8 lg:px-12">
            ...
            <div class="card m-5">
                <div class="card-header">
                    <h4 class="card-title">
                        Dicas que nossos usuários contribuiram
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('home') }}" method="GET">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <input type="text" name="contains[name]" id="name"
                                    class="form-control form-control-sm" placeholder="Nome"/>
                            </div>
                            <div class="form-group col-md-4">
                                <input type="text" name="contains[description]" id="dica"
                                    class="form-control form-control-sm" placeholder="Dica"/>
                            </div>
                            <div class="form-group col-md-4">
                                <input type="text" name="contains[user.name]" id="dica"
                                    class="form-control form-control-sm" placeholder="Usuário"/>
                            </div>
                            <div class="form-group col-md-4">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($tips as $tip)
                                <tr data-key="{{ $tip->id }}">
                                    <td scope="row">{{ $tip->name }}</td>
                                    <td>{{ $tip->description }}</td>
                                    <td>
                                        {{ $tip->user->name }}
                                    </td>
                                    <td>
                                        <a href="{{ route('show.tip', ['tipId' => $tip->id]) }}"
                                            class="btn btn-sm btn-outline-warning">Detalhes</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
